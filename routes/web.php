...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::get('/order/cancel/{order}', [OrderController::class, 'cancel'])->name('order.admincancel');
        Route::get('/order/receive/{order}', [OrderController::class, 'receive'])->name('order.adminreceive');
        Route::get('/order/return/{order}', [OrderController::class, 'return'])->name('order.adminreturn');
