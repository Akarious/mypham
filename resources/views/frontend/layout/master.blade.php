...
<head>
    ...
    <title>Việt Hương Cosmetics</title>

    <meta name="keywords" content="Việt Hương Cosmetics, Cosmetics, Mỹ phẩm chính hãng">
    <meta name="description" content="Việt Hương Cosmetics - Mỹ phẩm chính hãng">
                ...
                <div class="footer-top col-lg-12 col-xs-12">
                    <div class="row">
                        <div class="tiva-html col-lg-4 col-md-12 col-xs-12">
                            <div class="block">
                                <div class="block-content">
                                    ...
                                    <p class="content-logo">Với hơn 11 năm kinh nghiệm trong thị trường, Việt Hương Cosmetics không ngừng phát triển để nghiên cứu, sản xuất và cung cấp các sản phẩm mỹ phẩm an toàn, chất lượng và uy tín, vì một mục tiêu nâng tầm mỹ phẩm Việt
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="block-content">
                                    <div class="contact-us">
                                        ...
                                        <div class="content-contact address-contact">
                                            <p>Cụm Công Nghiệp Triều Khúc, Tân Triều, Thanh Trì, Hà Nội</p>
                                        </div>
                                    </div>
                                    <div class="contact-us">
                                        <div class="title-content">
                        ...
                        <div class="tiva-modules col-lg-4 col-md-6">
                            <div class="block m-top">
                                <div class="block-content">
                                    <div class="title-block">Nhận thông báo</div>
                                    <div class="sub-title">Đăng ký nhận bản tin của chúng tôi để nhận các bài viết, mã giảm giá mới nhất vào email của bạn
                                    </div>
                                    <div class="block-newsletter">
                                        <form action="#" method="post">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="email" value="" placeholder="Điền email của bạn">
                                            ...
                                            <div class="social">
                                                <ul class="list-inline mb-0 justify-content-end">
                                                    <li class="list-inline-item mb-0">
                                                        <a href="http://fb.me/viethuongcosmetics" target="_blank">
                                                            <i class="fa fa-facebook"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item mb-0">
                                                        <a href="http://youtube.com/channel/UCnBZU9NyVcHGi6Xp6G-OicA/" target="_blank">
